...
urlpatterns = [
    ...
    path('api/investors/request-token/', views.api_investor_request_token, name="api_investor_request_token"),
    path('api/investors/verify-token/', views.api_investor_verify_token, name="api_investor_verify_token"),
